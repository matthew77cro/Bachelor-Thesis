...
public class Agent : MonoBehaviour
{
    ...
    public const int NEURAL_NETWORK_INPUT = 2 * RAYS_ROWS * RAYS_PER_ROW;
    public const int COUNT_LEGAL_AGENTACTION_TUPLES = 22;
    public const int NEURAL_NETWORK_OUTPUT = COUNT_LEGAL_AGENTACTION_TUPLES;
